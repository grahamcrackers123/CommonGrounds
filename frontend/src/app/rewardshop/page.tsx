...
const shopItems: ShopItem[] = [
    ...
    // Pet Style
    {
        ...
        name: "Bandana",
        price: 500,
        imageUrl: "/assets/accessories/bandana.png",
        backgroundColor: "#F8E6D9",
        type: "pet",
    },
    {
        ...
        name: "Flower Crown",
        price: 500,
        imageUrl: "/assets/accessories/flower-crown.png",
        backgroundColor: "#DFF8EA",
        type: "pet",
    },
    {
        ...
        price: 500,
        imageUrl: "/assets/accessories/glasses.png",
        backgroundColor: "#F1EAFF",
        type: "pet",
    },
    {
        ...
        name: "Party Hat",
        price: 500,
        imageUrl: "/assets/accessories/party-hat.png",
    ...
    },
    {
        ...
        name: "Ribbon",
        price: 500,
        imageUrl: "/assets/accessories/ribbon.png",
    ...
    },
    {
        ...
        name: "Scarf",
        price: 500,
        imageUrl: "/assets/accessories/scarf.png",
    ...
    },
    {
        ...
        price: 100,
        imageUrl: "/assets/outfits/explorer-outfit.png",
    ...
    },
    {
        ...
        price: 100,
        imageUrl: "/assets/outfits/gardener-outfit.png",
    ...
    },
    {
        ...
        name: "Magical Outfit",
        price: 100,
        imageUrl: "/assets/outfits/magical-outfit.png",
    ...
    },
    {
        ...
        name: "Pajama Outfit",
        price: 100,
        imageUrl: "/assets/outfits/pajama-outfit.png",
    ...
    },
    {
        ...
        name: "Uniform Outfit",
        price: 100,
        imageUrl: "/assets/outfits/uniform-outfit.png",
    ...
    // Garden Decor
    {
        ...
        price: 3000,
        imageUrl: "/assets/garden-themes/moonlight-garden.png",
        type: "garden",
    },
    {
        id: 2,
        name: "Sakura Garden",
        price: 3000,
        imageUrl: "/assets/garden-themes/sakura-garden.png",
        type: "garden",
    },
];
...
export default function RewardShopPage() {
    ...
    const isOwned = (category: ItemCategory, id: number) =>
        ownedItems.includes(itemKey(category, id));
        ...
        modals.openConfirmModal({
                    ...
                    {!canAfford && (
                        ...
                        >
                            <Text size="sm" ta="center">
                                ...
                                {item.price - coins} more coins to
                                purchase this item.
                            </Text>
                        </Paper>
                    )}
            ...
            onConfirm: async () => {
                const res = await fetch("/api/rewards/purchase", {
                    ...
                    body: JSON.stringify({
                        itemId: itemKey(category, item.id),
                    }),
                });
    ...
    return (
        <Container
            ...
            miw="100%"
            style={{
                backgroundColor: "light-dark(#F7F9FC, #000000)",
                color: "light-dark(#000000, #FFFFFF)",
            }}
        >
            <Stack gap="md">
                                ...
                                <Badge
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: isActive
                                            ? "light-dark(#2F80ED, #1A1A1A)"
                                            : "transparent",
                                        color: isActive
                                            ? "light-dark(#FFFFFF, #FFFFFF)"
                                            : "light-dark(#495057, #B3B3B3)",
                                        borderColor: isActive
                                            ? "light-dark(#2F80ED, #292929)"
                                            : "light-dark(#ADB5BD, #292929)",
                                    }}
                                >
                                    {tab}
                                </Badge>
                ...
                <Flex direction="row" gap="md">
                    ...
                    <Box
                        ...
                        style={{
                            ...
                            border:
                                "1px solid light-dark(#CED4DA, #292929)",
                            borderRadius: "16px",
                            display: "flex",
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Image
                                        src="/assets/currency/student-coin.png"
                                        alt=""
                                        w="20px"
                                        h="20px"
                                    />
